...
Ниже представлен список всех типов сообщений, которые поддерживает бот:
  ...
  **1.** `Текстовые сообщения` — простые и удобные для общения.  
  **2.** `Мультимедийные сообщения` — видео, фотографии, GIF, стикеры, голосовые и видеосообщения.  
  **3.** `Сообщения с форматированием` — возможность использовать жирный, курсив, зачеркнутый текст и другие стили.  
  **4.** `Отредактированные сообщения` — бот поддерживает редактирование уже отправленных сообщений.  
