...
**`blocked_users.json`** — База данных пользователей, которые не могут попасть в чат с другим пользователем в течение 1 часа. Этот файл будет создан автоматически при завершении первого активного чата.  
